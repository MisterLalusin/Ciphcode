...
public class TapCodeActivity extends AppCompatActivity {
    ...
    public void characteroption() {
        ...
        character_option_character_5.setVisibility(View.GONE);
    ...
    public void tapcodedecrypt(){
        inputString = input.getText().toString().toLowerCase().replaceAll("\\(","\t\\(").replaceAll("\\)","\\)\t").replaceAll("\t","⁞");
        ...
        for (String splitline : inputString.split("\n")) {
            //tap code | to change space for temporary
            addextraspace = " " + splitline.replaceAll("• •","•_•") + " ";//for separator
            //tap code | to change space for temporary
        ...
        for (String newsplitline : addsequenceseparator.split("\n")) {
            //tap code | to change space for temporary
            newaddextraspace = "⁞" + newsplitline.replaceAll("• •","•_•") + "⁞";//for separator
            //tap code | to change space for temporary
