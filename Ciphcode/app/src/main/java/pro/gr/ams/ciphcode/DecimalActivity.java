...
public class DecimalActivity extends AppCompatActivity {
    ...
    String codesample = "68 101 99 105 109 97 108";
    ...
    public void decimalencrypt(){
        ...
        if (chkASCII.length() != 0) {
            ...
            for (int i = 0; i < inputString.getBytes().length; i++) {
                sb.append((inputString.getBytes()[i]));
                sb.append(" ");
            }
    ...
    public void decimaldecrypt() {
        ...
        if (chkvalidity.length() != 0) {
            ...
            String[] arrayDec = rmvSPC.split(" ");

            for (String arrayNew : arrayDec) {
                String proDec = (char)Integer.parseInt(arrayNew)+"";
                decCon = decCon + proDec;
            }
