...
public class TomTomCodesActivity extends AppCompatActivity {
    ...
    public void tomtomcodesencrypt(){
    ...
    public void tomtomcodesdecrypt(){
        //Tom Tom Codes
        inputString = input.getText().toString().toUpperCase().replaceAll(" "," [] ").replaceAll("-", " - ");
        //Tom Tom Codes
        ...
        else if(input.getText().toString().indexOf("- ")!=-1||input.getText().toString().indexOf(" -")!=-1||input.getText().toString().indexOf("  ")!=-1||input.getText().toString().indexOf("-\n")!=-1){
            Toast.makeText(getApplicationContext(), "Invalid format", Toast.LENGTH_SHORT).show();
        }
        //Cross Code
