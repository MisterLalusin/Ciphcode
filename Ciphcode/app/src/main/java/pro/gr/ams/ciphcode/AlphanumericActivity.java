...
public class AlphanumericActivity extends AppCompatActivity {

    String codename = "Alphanumeric";
    String codesample = "1 12 16 8 1 14 21 13 5 18 9 3";
    ...
    public void alphanumericencrypt(){
    ...
    public void alphanumericdecrypt(){
